...
local on_attach = function(client, bufnr)
    ...
    vim.keymap.set('n', '<leader><F6>', vim.lsp.buf.rename, bufopts)
    ...
    vim.diagnostic.config({
        ...
        float = {
            ...
            format = function(diagnostic)
                ...
                local code = ( -- TODO: symbol is specific to pylint (will be removed)
...
local servers = {"pyright", "rust_analyzer", "clangd", "cmake"}
