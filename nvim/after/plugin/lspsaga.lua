...
-- keymap("n", "<leader><F1>", "<cmd>Lspsaga show_cursor_diagnostics<CR>")
...
-- -- keymap("n", "<F2>", "<cmd>Lspsaga diagnostic_jump_prev<CR>")
-- keymap("n", "<F2>", "<cmd>Lspsaga diagnostic_jump_next<CR>")
--
...
-- keymap("n", "<leader>i", "<cmd>Lspsaga hover_doc ++keep<CR>")
--
-- -- Call hierarchy
